                ...
                <form id="data">
                    ...
                    <ul class="ulColumn2">
                        <li>
                            ...
                            <input type="text" class="textbox" name="link_name" datatype="*" nullmsg="名称不能为空！" errormsg="名称不能为空"/>
                        </li>
                        ...
                        <li>
                            ...
                            <input id="link_img" name="link_img" type="hidden"  value="">
                            <!--隐藏file按钮-->
                        ...
                        <li>
                            ...
                            <input type="text" class="textbox textbox_295" name="link_url" datatype="*" nullmsg="请填写网址！" errormsg="请填写网址"/>
                        </li>

                        <li>
                            <span class="item_name" style="width:120px;">友链权重：</span>
                            <input type="number" class="textbox" name="rank" datatype="*" value="0" nullmsg="请填写权重！" errormsg="请填写权重"/>
                        </li>

                        <li>
                            <span class="item_name" style="width:120px;">是否展示：</span>
                            <label class="single_selection"><input type="radio" name="status" value='1'/>展示</label>
                            <label class="single_selection"><input type="radio" name="status" value='0' datatype="*" errormsg="请选择！" />不展示</label>
                        </li>
...
@section('footer')
    ...
    <script>
        ...
        $(function() {
            ...
            function ajax_send() {
                $.ajax({
                    url: "{{URL::to('admin/siteFriendlink')}}",
                    type: "post",
