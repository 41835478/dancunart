                ...
                <form id="data">
                    <ul class="ulColumn2">
                        <li>
                            ...
                            <input type="text" class="textbox textbox_295" name="name" datatype="*" errormsg="名称不能为空！"/>
                        </li>

                        <li>
                            <span class="item_name" style="width:120px;">banner链接：</span>
                            <input type="text" class="textbox textbox_295" name="url" datatype="url" errormsg="链接不能为空！"/>
                        </li>
                        ...
                        <li>
                            ...
                            <input type="text" class="textbox" value="0" name="rank" datatype="n"/> &nbsp;&nbsp;&nbsp;权重越高 排名越靠前
                        </li>
